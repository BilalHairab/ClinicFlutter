...
mixin _$HomeState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(ErrorHandler handler) error,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<SpecializationsData?>? specializationDataList)?
        specializationsSuccess,
    TResult? Function(ErrorHandler handler)? error,
...
class _$SpecializationsErrorImpl implements SpecializationsError {
  const _$SpecializationsErrorImpl(this.handler);
  ...
  @override
  String toString() {
    return 'HomeState.error(handler: $handler)';
  }
...
abstract class SpecializationsError implements HomeState {
  const factory SpecializationsError(final ErrorHandler handler) =
      _$SpecializationsErrorImpl;

  ErrorHandler get handler;
  @JsonKey(ignore: true)
  _$$SpecializationsErrorImplCopyWith<_$SpecializationsErrorImpl>
      get copyWith => throw _privateConstructorUsedError;
}
