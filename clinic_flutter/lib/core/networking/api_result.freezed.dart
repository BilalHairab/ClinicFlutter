...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(ErrorHandler handler) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(T data)? success,
    TResult? Function(ErrorHandler handler)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$FailureImpl<T> implements Failure<T> {
  const _$FailureImpl(this.handler);
  ...
  @override
  String toString() {
    return 'ApiResult<$T>.failure(handler: $handler)';
  }
...
abstract class Failure<T> implements ApiResult<T> {
  const factory Failure(final ErrorHandler handler) = _$FailureImpl<T>;
